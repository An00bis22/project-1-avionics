...
{ 
  ...
  m.setMaxScaleValue(102);
  
  m.setNeedleThickness(3);
  
  m.setMinInputSignal(-20);
  ...
  String[] scaleLabelsH = {"0", "5", "10", "15", "20", "25"};
  ...
  String[] values = split(input, " ");
    ...
    float accelerometer_x = float(values[1]);
